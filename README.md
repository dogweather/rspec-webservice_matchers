...
If you're too busy to install this and code the tests by hand, you can try the [new hosted service which runs these RSpec matchers in the cloud](http://nonstop.qa): [![QA Status](http://nonstop.qa/projects/20-nonstop-qa/badge.svg)](http://nonstop.qa/projects/20-nonstop-qa)
